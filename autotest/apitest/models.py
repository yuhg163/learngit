...
class Apitest(models.Model):
    ...
    apitestdesc = models.CharField('描述',max_length=64,null=True,blank=True)  # 流程接口 描述
    apitester = models.CharField('测试负责人',max_length=16,null=True,blank=True)            # 执行人
...
class Apistep(models.Model):
    ...
    apiresponse = models.TextField('响应数据',null=True,blank=True)    # 响应数据    
